...
public class MainAuction extends Activity implements OnItemClickListener
{ 
    ...
    public void refresh()
	{
    	new Thread(new Runnable(){
		    ...
		    query.addWhereEqualTo("itemKind",3);
		    query.order("-createdAt");
		    //返回50条数据，如果不加上这条语句，默认返回10条数据
		    //query.setLimit(50);
		    //执行查询方法
		    query.findObjects(MainAuction.this, new FindListener<Item>() 
		    {
		    	@Override
		    	public void onSuccess(List<Item> object) 
		    	{
		    	    ...
		    	    else
		    	    {
		    	    	...
		    	    	itemAdapter = new ItemAdapter(MainAuction.this, R.layout.itemlist_item, itemList);
		    	    	itemListView = (ListView)findViewById(R.id.list);
		    	    	itemListView.setAdapter(itemAdapter);   	
		    	    	itemListView.setOnItemClickListener(MainAuction.this);
		    	    }
		    	}
		    	@Override
