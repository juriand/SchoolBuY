...
public class MainSee extends Activity implements OnItemClickListener
{ 
    ...
    public void refresh()
	{
    	new Thread(new Runnable(){
		    ...
		    query.setLimit(50);
		    //执行查询方法
		    query.findObjects(MainSee.this, new FindListener<Item>() 
		    {
		    	@Override
		    	public void onSuccess(List<Item> object) 
		    	{
		    	    ...
		    	    else
		    	    {
		    	    	...
		    	    	itemAdapter = new ItemAdapter(MainSee.this, R.layout.itemlist_item, itemList);
		    	    	itemListView = (ListView)findViewById(R.id.list);
		    	    	itemListView.setAdapter(itemAdapter);   	
		    	    	itemListView.setOnItemClickListener(MainSee.this);
		    	    }
		    	}
		    	@Override
